...
Provide the hostname also for syslog messages of type RFC 3164
(see PR [#201](https://github.com/emabee/flexi_logger/pull/201)). Kudos goes to
[julienjpk-withings](https://github.com/julienjpk-withings).
